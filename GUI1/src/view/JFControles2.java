 ...
 * @author User
 */
public class JFControles2 extends javax.swing.JFrame {

    /**
     * Creates new form JFControles2
     */
    public JFControles2() {
        initComponents();
        this.txtFormated1.setValue(new Integer(0));
    }
    ...
    private void initComponents() {
        ...
        txtFormated1 = new javax.swing.JFormattedTextField();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtDato1, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtFormated1, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtFormated1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(47, 47, 47)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int numeroTxt=0;
        try{
            numeroTxt=Integer.parseInt(this.txtDato1.getText());
        numeroTxt++;
        }catch (NumberFormatException ex){
            JOptionPane.showMessageDialog(null, ex, "El valor ingresado no es un numero", HEIGHT);
        }
        this.jLabel1.setText(""+numeroTxt);
        
        int numeroFormatedtTxt=Integer.parseInt(this.txtFormated1.getText());
        
        numeroFormatedtTxt++;
        this.jLabel2.setText(""+numeroFormatedtTxt);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void btnAreasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAreasActionPerformed
        // TODO add your handling code here:
        JFAreas objetoAreas=new JFAreas();
        objetoAreas.setVisible(true);
    ...
    private void btnControlesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnControlesActionPerformed
        // TODO add your handling code here:
        JFControles controles = new JFControles();
        int numeroTxt =Integer.parseInt(this.txtDato1.getText());
        JFVentana ventana=new JFVentana();
        controles.setNumero(numeroTxt);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFControles2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFControles2().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField txtFormated1;
